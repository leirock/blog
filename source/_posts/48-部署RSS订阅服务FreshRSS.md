...
![](https://cos.dlzhang.com/posts/48/rss.jpg!550x)
...
![创建新站点](https://cos.dlzhang.com/posts/48/create_site.jpg!500x)
...
![设置运行目录](https://cos.dlzhang.com/posts/48/site_path.jpg!500x)

完成后，访问之前创建网站时设置的域名，就可以进入安装设置程序了。

先设置好语言，检查完毕没有缺少的组件和权限后，如下图所示设置数据库（用户名、数据库名根据之前创建的信息填写）：

![数据库配置](https://cos.dlzhang.com/posts/48/db_settings.jpg!400x)
