...
![获取镜像](https://web-1256060851.file.myqcloud.com/images/2020/宝塔面板部署RSSHub和自动签到Docker应用/docker_mirror.jpg!500x)

然后，在「容器列表」创建新的 Docker 容器：

![创建 RSSHub 容器](https://web-1256060851.file.myqcloud.com/images/2020/宝塔面板部署RSSHub和自动签到Docker应用/rsshub_docker.jpg!400x)
...
![创建 RSSHub 容器](https://web-1256060851.file.myqcloud.com/images/2020/宝塔面板部署RSSHub和自动签到Docker应用/reverse_proxy.jpg!500x)
