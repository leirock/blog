...
if [ "$answer" == "1" ] || [ "$answer" == "" ]; then
	...
	echo " "
	sed -i "" 's#assets: https://web-1256060851.file.myqcloud.com/assets#assets: ""#g' _config.yml
	sed -i "" '18s/imageLink/imageLink.replace(\/\![0-9]{3,}x\/,"")/' themes/next/source/js/utils.js
	hexo s
	hexo clean
	sed -i "" 's#assets: ""#assets: https://web-1256060851.file.myqcloud.com/assets#g' _config.yml
